...
from .views import submit_questions2,get_question,push_question,fetch_UserTests,get_question_update
...
urlpatterns = [
    ...
    path('get-question/<int:testID>/', get_question, name='get_question'),
    ...
    path('get-question-update/<int:testID>/', get_question_update, name='get_question_update'),
]
